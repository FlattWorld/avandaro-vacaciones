...
export default function Nav({ role, fullName }: NavProps) {
  ...
  return (
    <>
      ...
      <header className="bg-white border-b border-slate-200 hidden sm:block">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-14 items-center justify-between">
            <div className="flex items-center gap-6">
              <span className="font-semibold text-slate-900 text-sm">Avándaro</span>
      ...
      {/* Barra superior móvil — solo muestra nombre y salir */}
      <header className="bg-white border-b border-slate-200 sm:hidden">
        <div className="flex h-12 items-center justify-between px-4">
          <span className="font-semibold text-slate-900 text-sm">Avándaro</span>
          <div className="flex items-center gap-3">
            <span className="text-xs text-slate-500 truncate max-w-[140px]">{fullName}</span>
            <form action="/auth/signout" method="post">
              <button type="submit" className="text-xs text-slate-400 hover:text-slate-700 transition-colors">
                Salir
              </button>
      ...
      <nav className="sm:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 z-50" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
        <div className="flex">
